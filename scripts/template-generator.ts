...
type TemplateKey = "base" | "header" | "navigation" | "footer";
type TemplateMap = Partial<Record<TemplateKey, string>>;
...
class TemplateGenerator {
   ...
   */
  private generateNavigationLinks(depth = 0, activePage = ""): TemplateVariables {
  ...
  private replaceVariables(template = "", variables: TemplateVariables) {
