...
class TemplateGenerator {
  ...
  loadTemplates() {
    ...
    try {
      this.templates.base = fs.readFileSync(
        path.join(__dirname, this.templatesDir, "base-template.html"),
        "utf8"
      );
      this.templates.header = fs.readFileSync(
        path.join(__dirname, this.templatesDir, "header.html"),
        "utf8"
      );
      this.templates.navigation = fs.readFileSync(
        path.join(__dirname, this.templatesDir, "navigation.html"),
        "utf8"
      );
      this.templates.footer = fs.readFileSync(
        path.join(__dirname, this.templatesDir, "footer.html"),
        "utf8"
      );
    } catch (error) {
