declare const PureCounter: new () => unknown;
declare const GLightbox: (options: { selector: string }) => unknown;
declare const Swiper: new (selector: string, options: Record<string, unknown>) => unknown;
declare const AOS: {
...
function initMobileNavigation() {
  ...
  document.querySelectorAll<HTMLElement>(".mobile-nav-toggle").forEach((toggle) => {
  ...
  document.querySelectorAll<HTMLAnchorElement>("#navbar a").forEach((navbarLink) => {
...
function initMobileDropdowns() {
  document.querySelectorAll<HTMLAnchorElement>(".navbar .dropdown > a").forEach((dropdownLink) => {
